    ...
    return AppCard(
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildSourceTab(
                label: '系统音色库',
                subtitle: 'Edge-TTS',
                isSelected: state.sourceType == VoiceSourceType.system,
                onTap: () => ref.read(voiceProvider.notifier).setSourceType(VoiceSourceType.system),
              ),
              const SizedBox(width: AppTheme.spacingSmall),
              _buildSourceTab(
                label: '我的克隆音色',
                subtitle: 'CosyVoice',
                isSelected: state.sourceType == VoiceSourceType.cloned,
                onTap: () => ref.read(voiceProvider.notifier).setSourceType(VoiceSourceType.cloned),
              ),
            ],
          ),
          const SizedBox(height: AppTheme.spacingMedium),
          ...
          else if (state.sourceType == VoiceSourceType.system)
